...
export function HomePage() {
  ...
  const handleFixCharacter = (characterId: string) => {
    migrateCharacterById(characterId)
  }
      ...
      <div className="text-center mb-16 animate-in fade-in duration-700">
        ...
        <div className="mt-6 flex justify-center gap-4">
          <button
            ...
            title={dmModeEnabled ? 'DM Mode Active' : 'Unlock DM Mode'}
          >
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    ...
                    {needsMigrationById(character.id) && (
                      <button
                        onClick={() => handleFixCharacter(character.id)}
                        className="flex items-center gap-1 px-3 py-2 text-sm bg-blue-600 text-white
                                 rounded-lg hover:bg-blue-500 shadow-md hover:shadow-lg
                                 transform hover:scale-105 transition-all duration-200"
                        title="Fix character data to work with latest version"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
