  ...
  features: [
    {
      ...
      description: 'You choose one type of dragon as your ancestor. You gain proficiency in Draconic and a bonus when interacting with dragons. <ref type="trait" id="dragon-ancestor">Full Details</ref>',
      level: 1,
    },
    {
      id: 'draconic-resilience',
      name: 'Draconic Resilience',
      description: 'Your hit point maximum increases by 1 for each sorcerer level. Your AC equals 13 + DEX modifier when not wearing armor. <ref type="trait" id="draconic-resilience">Full Details</ref>',
      level: 1,
    },
    {
      id: 'elemental-affinity',
      name: 'Elemental Affinity',
      description: 'When you cast a spell that deals damage of the type associated with your draconic ancestry, add your CHA modifier to that damage. <ref type="trait" id="elemental-affinity">Full Details</ref>',
      level: 6,
    },
    {
      id: 'dragon-wings',
      name: 'Dragon Wings',
      description: 'You gain the ability to sprout a pair of dragon wings from your back, gaining a flying speed equal to your current speed. <ref type="trait" id="dragon-wings">Full Details</ref>',
      level: 14,
    },
    {
      id: 'draconic-presence',
      name: 'Draconic Presence',
      description: 'As an action, you can spend 5 sorcery points to draw on your draconic presence. Each creature of your choice within 60 feet must succeed on a WIS save or become charmed or frightened for 1 minute. <ref type="trait" id="draconic-presence">Full Details</ref>',
      level: 18,
    },
  ],
}
  ...
  features: [
    {
      ...
      description: 'After you cast a sorcerer spell of 1st level or higher, the DM can have you roll a d20. If you roll a 1, roll on the <ref type="rule" id="wild-magic-surge-table">Wild Magic Surge table</ref>. <ref type="trait" id="wild-magic-surge">Full Details</ref>',
      level: 1,
    },
    {
      id: 'tides-of-chaos',
      name: 'Tides of Chaos',
      description: 'You can gain advantage on one attack roll, ability check, or saving throw. Once you do, you must finish a long rest before using this feature again, unless a Wild Magic Surge occurs. <ref type="trait" id="tides-of-chaos">Full Details</ref>',
      level: 1,
      charges: { amount: 1, rechargeOn: 'longRest' },
    },
    {
