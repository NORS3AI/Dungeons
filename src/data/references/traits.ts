...
export const TRAITS: Record<string, TraitRef> = {
  ...
  'lands-stride': {
    ...
    mechanics: "No extra movement cost for nonmagical difficult terrain. Pass through nonmagical plants freely.",
  },
  'hide-in-plain-sight': {
    id: 'hide-in-plain-sight',
    name: 'Hide in Plain Sight',
    source: 'Ranger (Level 10)',
    description: 'You can spend 1 minute creating camouflage for yourself. You must have access to fresh mud, dirt, plants, soot, and other naturally occurring materials. Once you are camouflaged this way, you can try to hide by pressing yourself up against a solid surface. You gain a +10 bonus to Dexterity (Stealth) checks as long as you remain there without moving or taking actions.',
    mechanics: '+10 to Stealth while stationary against a solid surface. Requires 1 minute to prepare camouflage.',
  },
  'vanish': {
    id: 'vanish',
    name: 'Vanish',
    ...
    mechanics: "Bonus action: Hide. Can't be tracked by nonmagical means.",
  },
  'feral-senses': {
    id: 'feral-senses',
    name: 'Feral Senses',
    ...
    mechanics: "No disadvantage on attacks vs. invisible creatures. Aware of invisible creatures within 30 ft.",
  },
  'foe-slayer': {
    id: 'foe-slayer',
    name: 'Foe Slayer',
