...
export const SPELLS: Record<string, SpellRef> = {
  ...
  'minor-illusion': {
    ...
    classes: ['Bard', 'Necromancer', 'Sorcerer', 'Warlock', 'Wizard'],
  ...
  'poison-spray': {
    ...
    classes: ['Druid', 'Necromancer', 'Sorcerer', 'Warlock', 'Wizard'],
    sourceBook: { ...SOURCE_BOOKS.PHB2024, page: 307 },
  },
  ...
  'bone-splinter': {
    ...
    components: 'V, S',
    duration: 'Instantaneous',
    description: 'Conjure a shard of sharpened bone and hurl it at a creature. Make a ranged spell attack. On a hit, the target takes 1d8 piercing damage. If the target is a corpse or undead, the shard splinters and one creature within 5 feet takes 1d4 piercing damage.',
    higherLevels: 'Damage increases by 1d8 (and 1d4 splash) at 5th level (2d8/2d4), 11th level (3d8/3d4), and 17th level (4d8/4d4).',
    classes: ['Necromancer'],
  },
  'corpse-burst': {
    id: 'corpse-burst',
    ...
    components: 'V, S',
    duration: 'Instantaneous',
    description: 'Point at a corpse of a Small or larger creature within range, causing it to pop with necrotic energy. Each creature within 5 feet must succeed on a DEX save or take 1d6 necrotic damage. The corpse is destroyed. If no corpse is available, the spell fails.',
  ...
  'grasp-of-the-dead': {
    ...
    components: 'V, S',
    duration: 'Instantaneous',
    description: 'Skeletal hands claw up from the ground beneath a creature you can see within range. The target must succeed on a STR save or take 1d6 necrotic damage and have its speed reduced by 10 feet until the end of its next turn.',
    higherLevels: 'Damage increases by 1d6 at 5th level (2d6), 11th level (3d6), and 17th level (4d6).',
    classes: ['Necromancer'],
  },
  'blood-siphon': {
    ...
    components: 'V, S',
    duration: 'Instantaneous',
    description: 'Pull at the life force of a creature you can see within range. The target must succeed on a CON save or take 1d6 necrotic damage. On a failed save, you gain temporary hit points equal to half the damage dealt (minimum 1).',
    higherLevels: 'Damage increases by 1d6 at 5th level (2d6), 11th level (3d6), and 17th level (4d6).',
    classes: ['Necromancer'],
  },
  'spectral-scythe': {
    ...
    components: 'V, S',
    duration: 'Instantaneous',
    description: 'Sweep your hand in an arc and a ghostly scythe blade materializes. Make a melee spell attack. On a hit, the target takes 1d10 necrotic damage. If this reduces the target to 0 HP, you gain 1d4 temporary hit points.',
