...
export const SPELLS: Record<string, SpellRef> = {
  ...
  'green-flame-blade': {
    ...
    components: 'S, M (a melee weapon worth at least 1 sp)',
    duration: 'Instantaneous',
    description: 'You brandish the weapon used in the spell\'s casting and make a melee attack with it against one creature within 5 feet of you. On a hit, the target suffers the weapon attack\'s normal effects, and green fire leaps from the target to a different creature of your choice that you can see within 5 feet of it. The second creature takes fire damage equal to your spellcasting ability modifier.',
    classes: ['Artificer', 'Sorcerer', 'Warlock', 'Wizard'],
  },
  'mind-sliver': {
    id: 'mind-sliver',
  ...
  'magic-stone': {
    ...
    components: 'V, S',
    duration: '1 minute',
    description: 'You touch one to three pebbles and imbue them with magic. You or someone else can make a ranged spell attack with one of the pebbles by throwing it or hurling it with a sling. If thrown, a pebble has a range of 60 feet. On a hit, the target takes bludgeoning damage equal to 1d6 + your spellcasting ability modifier.',
  ...
  'shape-water': {
    ...
    description: 'You choose an area of water that you can see within range and that fits within a 5-foot cube. You manipulate it in one of several ways: move/flow the water, form simple shapes, change color/opacity, or freeze the water (provided there are no creatures in it). If you cast this spell multiple times, you can have no more than two of its non-instantaneous effects active at a time.',
  ...
  'control-flames': {
    ...
    components: 'S',
    duration: 'Instantaneous or 1 hour',
    description: 'You choose nonmagical flame that you can see within range and that fits within a 5-foot cube. You affect it in one of the following ways: expand flame 5 feet in one direction, extinguish flames, double or halve the area of bright/dim light, or cause simple shapes to appear within the flames.',
    classes: ['Druid', 'Sorcerer', 'Wizard'],
  },
  'gust': {
    id: 'gust',
    ...
    components: 'V, S',
    duration: 'Instantaneous',
    description: 'You seize the air and compel it to create one of the following effects: push a Medium or smaller creature 5 feet away (Str save negates), push an unattended object weighing up to 5 pounds 10 feet away, or create a harmless sensory effect using air (rustling leaves, shutting a door, etc.).',
    classes: ['Druid', 'Sorcerer', 'Wizard'],
  },
  'mold-earth': {
    id: 'mold-earth',
    ...
    components: 'S',
    duration: 'Instantaneous or 1 hour',
    description: 'You choose a portion of dirt or stone that you can see within range and that fits within a 5-foot cube. You manipulate it in one of the following ways: excavate and move loose earth, cause shapes/colors/words to appear, make ground difficult terrain or normal terrain.',
    classes: ['Druid', 'Sorcerer', 'Wizard'],
  },
  'encode-thoughts': {
    id: 'encode-thoughts',
    ...
    components: 'S',
    duration: '8 hours',
    description: 'Putting a finger to your head, you pull a memory, an idea, or a message from your mind and transform it into a tangible string of glowing energy called a thought strand, which persists for the duration or until you cast this spell again. Anyone holding the thought strand can use an action to absorb the thought.',
    classes: ['Wizard'],
  },
  'sapping-sting': {
    id: 'sapping-sting',
  ...
  'elementalism': {
    ...
    components: 'V, S',
    duration: 'Instantaneous',
    description: 'You exert control over the elements, creating one of the following effects within range: Breeze (move cloth, dust, leaves, or open/close doors in a 5-foot cube), Dust/Sand (create a shroud or write a word), Embers (create harmless sparks of any color that can light candles/torches/lamps), Water (create one cup of clean water or spray damp mist), or Earth (shape a one-foot cube of dirt, sand, fire, smoke, mist, or water into a crude form for 1 hour).',
    classes: ['Druid', 'Sorcerer', 'Wizard'],
  },
  'sorcerous-burst': {
    id: 'sorcerous-burst',
    ...
    components: 'V, S',
    duration: 'Instantaneous',
    description: 'You cast sorcerous energy at one creature or object within range. Make a ranged spell attack against the target. On a hit, the target takes 1d8 damage of a type you choose: acid, cold, fire, lightning, poison, psychic, or thunder. If you roll an 8 on a damage die, you can roll another d8 and add it to the damage. You can add a number of extra d8s equal to your spellcasting ability modifier. Damage increases by 1d8 at 5th, 11th, and 17th level.',
    classes: ['Sorcerer'],
  },
  'starry-wisp': {
    id: 'starry-wisp',
  ...
  'arcane-vigor': {
    ...
    components: 'V, S',
    duration: 'Instantaneous',
    description: 'You tap into your life force to heal yourself. Roll 2d8 + your spellcasting ability modifier. You regain a number of hit points equal to the total. You also end one condition on yourself that is causing you to be Charmed or Frightened.',
  ...
  'mind-spike': {
    ...
    components: 'S',
    duration: 'Concentration, up to 1 hour',
    description: 'You drive a disorienting spike of psychic energy into the mind of one creature you can see within range. The target must succeed on a Wisdom saving throw or take 3d8 psychic damage. On a failed save, you also always know the target\'s location until the spell ends, but only while the two of you are on the same plane of existence.',
  ...
  'tashas-bubbling-cauldron': {
    ...
    castingTime: '1 action',
    range: '5 feet',
    components: 'V, S, M (a cauldron worth at least 100 gp)',
    duration: '10 minutes',
    description: 'You conjure a claw-footed cauldron filled with bubbling liquid. The cauldron appears in an unoccupied space on the ground within 5 feet of you and lasts for the duration. The cauldron can\'t be moved and disappears when the spell ends. The magical concoction within the cauldron produces a number of potions: 1 greater healing, 2 regular healing, and 2 climbing potions. A creature can use a bonus action to drink one of these potions. The potions follow normal rules and become nonmagical when the spell ends.',
    classes: ['Wizard'],
  },
  'vitriolic-sphere': {
    id: 'vitriolic-sphere',
  ...
  'yolandes-regal-presence': {
    ...
    castingTime: '1 action',
    range: 'Self',
    components: 'V, S, M (a miniature crown)',
    duration: 'Concentration, up to 1 minute',
    description: 'You surround yourself with unearthly majesty in a 10-foot emanation. Whenever a creature starts its turn in this area or enters it, you can force that creature to make a Wisdom saving throw. On a failed save, the target has the Charmed condition until the start of its next turn, and on its turn it must Dodge and end its turn. On a successful save, the target is unaffected and is immune to this spell for 24 hours. You can also cause yourself to appear differently for the duration, as if you had cast Disguise Self.',
    classes: ['Bard', 'Wizard'],
  },
  // Level 6 Spells
  'blade-barrier': {
