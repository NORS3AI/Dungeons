...
export const BLACKSMITHING_RECIPES: CraftedItem[] = [
  ...
  },
  {
    ...
    bonus: '+1 Initiative', speedBonus: 0,
  },
  {
  ...
  },
  {
    ...
    bonus: 'Spell: Prestidigitation (at will)',
  },
  {
  ...
  },
  {
    ...
    bonus: "Spell: Hunter's Mark (1/day)",
  },
  {
  ...
  },
  {
    ...
    bonus: 'Spell: Magic Missile (1/day)',
  },
  {
  ...
  },
  {
    ...
    bonus: 'Spell: Invisibility (1/day)',
  },
  {
  ...
  // ── Epic (Tier 4) ─────────────────────────────────────────────────────────
  {
    ...
    bonus: "Spell: Crusader's Mantle (1/day)",
  },
  {
  ...
  },
  {
    ...
    bonus: 'Spell: Compelled Duel (2/day)',
  },
  {
...
export const TAILORING_RECIPES: CraftedItem[] = [
  // ── Common (Tier 1) ───────────────────────────────────────────────────────
  {
    ...
    weight: 1, hpBonus: 1, bonus: '+1 Max HP',
  },
  {
  ...
  },
  {
    ...
    weight: 15, acBonus: 1, bonus: '+1 AC',
  },
  {
  ...
  },
  {
    ...
    weight: 5, hpBonus: 2, bonus: '+2 Max HP',
  },
  {
  ...
  },
  {
    ...
    materials: [{ materialId: 'wool-cloth', label: 'Wool Cloth', quantity: 3 }],
    weight: 4, acBonus: 1, bonus: '+1 AC',
  },
  {
    id: 'craft-sandals-common', name: 'Sandals', tier: 'common', minSkill: 1,
    materials: [{ materialId: 'light-hide', label: 'Light Animal Hide', quantity: 1 }],
    weight: 0.5, speedBonus: 1, bonus: '+1 Speed',
  },
  ...
  // ── Uncommon (Tier 2) ─────────────────────────────────────────────────────
  {
    ...
    weight: 2, hpBonus: 2, bonus: '+2 Max HP',
  },
  {
  ...
  },
  {
    ...
    weight: 10, acBonus: 1, hpBonus: 2, bonus: '+1 AC, +2 Max HP',
  },
  {
  ...
  },
  {
    ...
    weight: 7, hpBonus: 3, bonus: '+3 Max HP',
  },
  {
  ...
  },
  {
    ...
    weight: 5, acBonus: 1, hpBonus: 1, bonus: '+1 AC, +1 Max HP',
  },
  {
    id: 'craft-sandals-uncommon', name: 'Soft Sandals', tier: 'uncommon', minSkill: 26,
    materials: [{ materialId: 'thick-hide', label: 'Thick Leather Hide', quantity: 1 }],
    weight: 1, speedBonus: 3, bonus: '+3 Speed',
  },
  ...
  // ── Rare (Tier 3) ─────────────────────────────────────────────────────────
  {
    ...
    weight: 3, acBonus: 1, hpBonus: 2, bonus: '+1 AC, +2 Max HP',
  },
  {
    ...
    weight: 3, hpBonus: 4, bonus: '+4 Max HP',
  },
  {
    ...
    weight: 20, acBonus: 2, hpBonus: 5, bonus: '+2 AC, +5 Max HP',
  },
  {
  ...
  },
  {
    ...
    weight: 6, acBonus: 1, hpBonus: 3, bonus: '+1 AC, +3 Max HP',
  },
  {
    id: 'craft-sandals-rare', name: 'Durable Sandals', tier: 'rare', minSkill: 51,
    materials: [{ materialId: 'scaled-hide', label: 'Scaled Beast Hide', quantity: 1 }],
    weight: 2, speedBonus: 4, hpBonus: 2, bonus: '+4 Speed, +2 Max HP',
  },
  ...
  // ── Epic (Tier 4) ─────────────────────────────────────────────────────────
  {
    ...
    weight: 5, acBonus: 2, hpBonus: 5, bonus: '+2 AC, +5 Max HP',
  },
  {
    ...
    weight: 4, acBonus: 1, hpBonus: 8, bonus: '+1 AC, +8 Max HP',
  },
  {
    ...
    weight: 30, acBonus: 3, hpBonus: 10, bonus: '+3 AC, +10 Max HP',
  },
  {
  ...
  },
  {
    ...
    weight: 8, acBonus: 2, hpBonus: 5, bonus: '+2 AC, +5 Max HP',
  },
  {
    id: 'craft-sandals-epic', name: 'Iron Sandals', tier: 'epic', minSkill: 76,
    materials: [{ materialId: 'wyvern-hide', label: 'Wyvern Hide', quantity: 1 }],
    weight: 4, speedBonus: 7, acBonus: 1, bonus: '+7 Speed, +1 AC',
  },
  ...
  // ── Legendary (Tier 5) ────────────────────────────────────────────────────
  {
    ...
    weight: 6, acBonus: 3, hpBonus: 15, bonus: '+3 AC, +15 Max HP',
  },
  {
    ...
    weight: 5, acBonus: 2, hpBonus: 15, bonus: '+2 AC, +15 Max HP',
  },
  {
    ...
    weight: 35, acBonus: 4, hpBonus: 25, bonus: '+4 AC, +25 Max HP',
  },
  {
    ...
    weight: 7, acBonus: 3, hpBonus: 10, bonus: '+3 AC, +10 Max HP',
  },
  {
    id: 'craft-pants-legendary', name: 'Eternal Pants', tier: 'legendary', minSkill: 91,
    materials: [{ materialId: 'dragonscale-leather', label: 'Dragonscale Leather Hide', quantity: 1 }, { materialId: 'void-silk', label: 'Void Silk', quantity: 1 }],
    weight: 15, acBonus: 2, hpBonus: 20, bonus: '+2 AC, +20 Max HP',
  },
  {
    id: 'craft-boots-legendary', name: 'Eternal Boots', tier: 'legendary', minSkill: 91,
    materials: [{ materialId: 'dragonscale-leather', label: 'Dragonscale Leather Hide', quantity: 1 }],
    weight: 6, speedBonus: 10, acBonus: 1, bonus: '+10 Speed, +1 AC',
  },
  {
...
export const ALCHEMY_RECIPES: CraftedItem[] = [
  // ── Common (Tier 1) ───────────────────────────────────────────────────────
  {
    ...
    weight: 0.5, bonus: 'Restores 1d4+1 HP on use',
  },
  {
    ...
    weight: 0.5, bonus: '+1 AC for 1 minute',
  },
  {
    ...
    weight: 0.5, bonus: '+1 to next Initiative roll',
  },
  {
    ...
    weight: 0.5, bonus: 'Disadvantage to attackers for 1 round',
  },
  ...
  // ── Uncommon (Tier 2) ─────────────────────────────────────────────────────
  {
    ...
    weight: 0.5, bonus: 'Restores 2d4+2 HP on use',
  },
  {
    ...
    weight: 0.5, bonus: '+2 AC for 10 minutes',
  },
  {
    ...
    weight: 0.5, bonus: '+2 Initiative, +5 Speed for 1 hour',
  },
  {
    ...
    weight: 0.5, bonus: 'Invisibility for 1 minute (breaks on attack/spell)',
  },
  ...
  // ── Rare (Tier 3) ─────────────────────────────────────────────────────────
  {
    ...
    weight: 0.5, bonus: 'Restores 3d4+3 HP on use',
  },
  {
    ...
    weight: 0.5, bonus: '+3 AC for 1 hour',
  },
  {
    ...
    weight: 0.5, bonus: '+3 Initiative, Dash as bonus action once per combat',
  },
  {
    id: 'craft-pot-fade-invis', name: 'Fade Invisibility Potion', tier: 'rare', minSkill: 51,
    materials: [{ materialId: 'rare-herb-mandrake', label: 'Mandrake Root', quantity: 2 }],
    weight: 0.5, bonus: 'Invisibility for 10 minutes (breaks on attack/spell)',
  },
  ...
  // ── Epic (Tier 4) ─────────────────────────────────────────────────────────
  {
    ...
    weight: 0.5, bonus: 'Restores 5d4+5 HP on use',
  },
  {
    ...
    weight: 0.5, bonus: '+4 AC for 1 hour',
  },
  {
    ...
    weight: 0.5, bonus: '+4 Initiative, cannot be Surprised',
  },
  {
    id: 'craft-pot-vanish-invis', name: 'Vanish Invisibility Potion', tier: 'epic', minSkill: 76,
    materials: [{ materialId: 'rare-herb-phoenix', label: 'Phoenix Feather Grass', quantity: 1 }],
    weight: 0.5, bonus: 'Invisibility for 1 hour; one attack/spell before breaking',
  },
  ...
  // ── Legendary (Tier 5) ────────────────────────────────────────────────────
  {
    ...
    weight: 0.5, bonus: 'Restores 6d4+10 HP on use',
  },
  {
    ...
    weight: 0.5, bonus: '+5 AC for 1 hour',
  },
  {
    ...
    weight: 0.5, bonus: '+6 Initiative, extra Reaction in first round',
  },
  {
    id: 'craft-pot-true-invis', name: 'True Invisibility Potion', tier: 'legendary', minSkill: 91,
    materials: [{ materialId: 'legendary-herb-soulroot', label: 'Soulroot', quantity: 1 }],
    weight: 0.5, bonus: 'Invisibility for 8 hours; breaks only on damage or AoE hit',
  },
]
