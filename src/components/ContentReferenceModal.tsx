...
const CLASS_INFO: Record<string, ClassInfo> = {
  ...
  Necromancer: {
    ...
    saves: 'Intelligence & Wisdom',
    features: [
      { name: 'Essence - Resource pool (10 + level) that regenerates from death', id: 'essence' },
      { name: 'Raise Skeleton - Summon skeleton warriors (max = INT modifier)', id: 'raise-skeleton' },
      { name: 'Bone Spear - Launch piercing bone projectiles at enemies', id: 'bone-spear' },
      { name: 'Corpse Explosion - Detonate corpses for massive AoE damage', id: 'corpse-explosion' },
      { name: 'Army of the Dead - Summon massive horde of undead temporarily', id: 'army-of-the-dead' },
    ],
    spellcaster: true,
    ...
    subclasses: [
      {
        ...
        features: [
          { name: 'Bone Armor - Summon protective bone plating for damage reduction', id: 'bone-armor' },
          { name: 'Bone Prison - Trap enemies in cages of bone', id: 'bone-prison' },
          { name: 'Bone Spirit - Launch homing bone projectile that explodes', id: 'bone-spirit' },
          { name: 'Bone Wall - Create impassable wall of bones', id: 'bone-wall' },
        ],
      ...
      },
      {
        ...
        features: [
          { name: 'Blood Nova - Detonate corpses dealing massive damage', id: 'blood-nova' },
          { name: 'Drain Life - Siphon life force from enemies to heal yourself', id: 'drain-life' },
          { name: 'Iron Maiden - Reflect damage back to attackers', id: 'iron-maiden' },
          { name: 'Blood Golem - Summon a powerful blood construct', id: 'blood-golem' },
        ],
      ...
      },
      {
        ...
        features: [
          { name: 'Skeletal Mages - Summon ranged skeleton mages', id: 'skeletal-mages' },
          { name: 'Revive - Bring back fallen undead minions', id: 'revive' },
          { name: 'Golem Mastery - Create clay, blood, iron, or fire golems', id: 'golem-mastery' },
          { name: 'Army of the Dead - Summon massive temporary undead horde', id: 'army-of-the-dead' },
        ],
